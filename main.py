...
#     st.set_page_config(layout="wide")
    ...
    if file is not None: 
        ...
        st.dataframe(control_frame.style.apply(lambda x: ("background-color: green","background-color: green") if x['target_rate']<x['threshold'] else ("background-color: red","background-color: red"),axis = 1))
        df_ = df.copy()
